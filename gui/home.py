...
# ══════════════════════════════════════════════════════════════════════════════
# Dev 2 — Configuração de exclusões via GUI
# ══════════════════════════════════════════════════════════════════════════════
...
def render_upload_section() -> tuple[Any, list[str]]:
    ...
    st.markdown(
        f'<div class="upload-box">📦 Arraste ou selecione o <b>.zip</b> do seu projeto<br>'
        f"<small>Tamanho máximo: <b>{MAX_ZIP_SIZE_MB} MB</b></small></div>",
        unsafe_allow_html=True,
    )
...
# ══════════════════════════════════════════════════════════════════════════════
# Renderização do relatório (Dev 4 + Dev 5 integrados)
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# Processamento do upload (Dev 2: limpeza automática + exclusões configuráveis)
# ══════════════════════════════════════════════════════════════════════════════
